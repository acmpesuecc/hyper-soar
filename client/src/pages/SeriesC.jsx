...
const SeriesC = () => {
    const product = { id: 3, name: 'Drone C', description: 'Our flagship drone, designed to operate in the harshest environments.' };
            ...
            <div className='h-[70%] w-[95%] flex md:flex-row flex-col'>
                ...
                <div className='w-full md:w-[50%] flex flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-row mt-[20%] gap-16'>
                        ...
                        <button onClick={addToCart} className='absolute rounded-lg right-12 bottom-36 flex flex-row w-28 pl-3 pt-1 h-10 bg-green text-white'>Add to Cart</button>
                    </div>
                </div>
            </div>
